...
- `sms2telegram_1.0.3_all.ipk`
- `sms2telegram_1.0.3_all.ipk.sha256`

可在电脑上校验文件：

```sh
shasum -a 256 -c sms2telegram_1.0.3_all.ipk.sha256
```

Linux/OpenWrt 也可使用：

```sh
sha256sum -c sms2telegram_1.0.3_all.ipk.sha256
```
